# Don't Remove Credit Tg - @A K A S H0125
# Ask Doubt on telegram @A K A S H0125
...
OWNER_ID = 1651746145 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [7924379211]

AUTH_CHANNEL = -1002614495355
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/akash8911") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/CA_AKASH_SHARMA") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/PrimeCristianoRonaldo")                              
                ],           
            ]
      )
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/akash` - Download and upload files (sudo)🎬\n\n"
...
@bot.on_message(filters.command(["akash"]))
async def upload(bot: Client, m: Message):
    ...
    credit = "️[A K A S H](https://t.me/akash8911)"
    if raw_text3 == '1':
        CR = '[A K A S H](https://t.me/akash8911)'
    elif raw_text3:
        try:
